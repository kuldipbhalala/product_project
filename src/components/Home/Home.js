          ...
          <div className="container py-6">
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                <a href="#" className="btn btn-white btn-white btn-icon rounded-pill hover-translate-y-n3 mt-4">
                  <span className="btn-inner--text">Start shopping</span>
              ...
              <div className="tab-content bestsellers-tabs" id="myTabContent">
                <div className="tab-pane fade show active" id="p1" role="tabpanel" aria-labelledby="shopping-tab">
                  <div className="col-lg-12">
                    ...
                    <div className="row">
                      {
                        product?.slice(0, 8).map((items, key) => (

                          <div className="col-xl-3 col-lg-4 col-sm-6 product-box">
                            <div className="card card-product">
                              <div className="card-image">
                                <a href="#">
                                  <img alt="Image placeholder" src={items.image} style={{ aspectRatio: 2 / 2 }} className="img-center img-fluid" />
                                </a>
                              </div>
                              <div className="card-body pt-0">
                                ...
                                <h6><a className="t-black13" href="#">{items.title}</a></h6>
                                <p className="text-sm">
                                  <span className="td-gray">Category:</span> {items.category}
                                </p>
                ...
                <div className="tab-pane fade" id="p2" role="tabpanel" aria-labelledby="electronic-tab">
                  <div className="col-lg-12">
                            ...
                            <div className="col-xl-3 col-lg-4 col-sm-6 product-box">
                              <div className="card card-product">
                                ...
                                <div className="card-body pt-0">
                                  ...
                                  <div className="product-price mt-3">
                                    <span className="card-price t-black15"> {items.category}</span>
                                    <button type="button" className="action-item pcart-icon bg-primary" data-toggle="tooltip" data-original-title="Wishlist">
                                      <svg className="w-auto" height={21} viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M4 8.5C4 9.05229 4.44772 9.5 5 9.5C5.55228 9.5 6 9.05229 6 8.5V6.5H10V8.5C10 9.05229 10.4477 9.5 11 9.5C11.5523 9.5 12 9.05229 12 8.5V6.5H14V15.5C14 17.1569 12.6569 18.5 11 18.5H5C3.34315 18.5 2 17.1569 2 15.5V6.5H4V8.5ZM6 4.5H10C10 3.39543 9.10457 2.5 8 2.5C6.89543 2.5 6 3.39543 6 4.5ZM12 4.5C12 2.29086 10.2091 0.5 8 0.5C5.79086 0.5 4 2.29086 4 4.5L1 4.5C0.447715 4.5 0 4.94772 0 5.5V15.5C0 18.2614 2.23858 20.5 5 20.5H11C13.7614 20.5 16 18.2614 16 15.5V5.5C16 4.94772 15.5523 4.5 15 4.5H12Z" fill="white" />
                                      </svg>
                ...
                {
                  product?.slice(0, 1).map((items, key) => (


                    <div className="tab-pane fade" id="p3" role="tabpanel" aria-labelledby="software-tab">
                      <div className="col-lg-12">
                        <div className="row">
                          <div className="col-xl-3 col-lg-4 col-sm-6 product-box">
                            <div className="card card-product">
                ...
                <div className="tab-pane fade" id="p4" role="tabpanel" aria-labelledby="notebooks-tab">
                  <div className="col-lg-12">
                    <div className="row">

                      {
                        product?.slice(8, 16).map((items, key) => (
                ...
                <div className="tab-pane fade" id="p5" role="tabpanel" aria-labelledby="phone-tab">
                  <div className="col-lg-12">
                    <div className="row">


                      {
                        product?.slice(19, 20).map((items, key) => (
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="pr-title">
              <h3 className=" mt-4 store-title text-primary">Top rated products</h3>
              <a href="#" className="btn btn-sm btn-primary rounded-pill btn-icon">
                <span className="btn-inner--text">Show more products</span>
                <span className="btn-inner--icon">
                  <svg className="w-auto" height={21} viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M4 8.5C4 9.05229 4.44772 9.5 5 9.5C5.55228 9.5 6 9.05229 6 8.5V6.5H10V8.5C10 9.05229 10.4477 9.5 11 9.5C11.5523 9.5 12 9.05229 12 8.5V6.5H14V15.5C14 17.1569 12.6569 18.5 11 18.5H5C3.34315 18.5 2 17.1569 2 15.5V6.5H4V8.5ZM6 4.5H10C10 3.39543 9.10457 2.5 8 2.5C6.89543 2.5 6 3.39543 6 4.5ZM12 4.5C12 2.29086 10.2091 0.5 8 0.5C5.79086 0.5 4 2.29086 4 4.5L1 4.5C0.447715 4.5 0 4.94772 0 5.5V15.5C0 18.2614 2.23858 20.5 5 20.5H11C13.7614 20.5 16 18.2614 16 15.5V5.5C16 4.94772 15.5523 4.5 15 4.5H12Z" fill="white" />
          ...
          <div className="row">
            ...
            {
              product?.slice(10, 14).map((items, key) => (
      ...
      <section className="categorie-section">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="mb-5 text-center">
                <h3 className=" mt-4 store-title text-primary">Categories</h3>
                <div className="fluid-paragraph mt-3">
                  <p className="lead lh-180 store-dcs">There is only that moment and the incredible certainty <br /> that
                    everything
                    under the sun has been written by one hand only.</p>
                </div>
              </div>
          ...
          <div className="row justify-content-center">
            ...
            {
              product?.slice(0, 3).map((items, key) => (
